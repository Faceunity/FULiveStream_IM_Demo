...
//        self.alpha = 0.5;
        ...
        self.versionKey = [[UILabel alloc] initWithFrame:CGRectMake(kStartLeft, 3*kHeight, kWidth, kHeight)];
        self.versionKey.text = @"SDK版本:";
        self.versionKey.textColor = [UIColor blackColor];
        self.versionKey.textAlignment = NSTextAlignmentLeft;
        [self addSubview:self.versionKey];
        
        self.versionValue = [[UILabel alloc] initWithFrame:CGRectMake(kStartLeft+kWidth, 3*kHeight, kWidth, kHeight)];
        self.versionValue.textColor = [UIColor redColor];
        self.versionValue.textAlignment = NSTextAlignmentLeft;
        [self addSubview:self.versionValue];
...
-(void)dispalyInfo:(LSStatisticsObject*)pStatistic{
...
-(void)dispalyVersion:(NSString *)version{
