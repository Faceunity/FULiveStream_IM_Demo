...
@interface NTESNormalMessageView ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation NTESNormalMessageView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    __weak typeof(self) weakSelf = self;
    model.messageClickBlock = ^(NSString *string){
        __strong typeof(weakSelf) strongSelf = weakSelf;
        if (strongSelf.delegate && [strongSelf.delegate respondsToSelector:@selector(normalMessageView:clickUserId:)]) {
            [weakSelf.delegate normalMessageView:self clickUserId:string];
        }
    };
